...
<article class="tut">
  ...
  <p class="muted" style="margin:6px 0"><b>收获是自动结算的，不占人力、不用点任何按钮</b>——第 4 / 7 / 9 / 11 / 13 / 14 轮所有人放完工人的瞬间，三个阶段依次自动执行。</p>
  <h3>① 🌾 田地阶段（自动）</h3>
  <p>每块<b>已播种</b>的田<b>自动</b>收进 <b>1 个</b>谷/菜到你的库存（剩余的标记留在田里，等下次收获再收）。<br>
    谷田撒一次可收 <b>3 次</b>，菜田可收 <b>2 次</b>；标记用完后田变空，可以重新撒种。<b>全程不需要派工人</b>，也不占用任何行动。</p>
  <h3>② 🍞 喂养阶段（自动）</h3>
