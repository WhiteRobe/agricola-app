...
export const OCCUPATIONS: Occupation[] = [
  ...
  // 1. 基础资源流派（15 张）
  // ==========================================
  { id: "woodcutter", name: "伐木工", icon: "🪓", category: "resource", categoryZh: "基础资源", effect: "每轮开始：额外获得 1 木", flavor: "开局就攒建材，适合冲房子" },
  { id: "clayworker", name: "泥瓦工", icon: "🏺", category: "resource", categoryZh: "基础资源", effect: "每轮开始：额外获得 1 陶", flavor: "抢陶屋用的狠角色" },
  { id: "reedcutter", name: "芦苇工", icon: "🎋", category: "resource", categoryZh: "基础资源", effect: "每轮开始：额外获得 1 芦苇", flavor: "建第 3 间房必备" },
  { id: "stonemason", name: "石匠", icon: "⛏", category: "resource", categoryZh: "基础资源", effect: "每轮开始：额外获得 1 石", flavor: "后期翻修派的最爱" },
  { id: "lumberjack", name: "柴夫", icon: "🪵", category: "resource", categoryZh: "基础资源", effect: "拿木材行动：额外多拿 1 木", flavor: "树林劳作的高手" },
  { id: "clayCarrier", name: "运泥工", icon: "🧱", category: "resource", categoryZh: "基础资源", effect: "拿陶土行动：额外多拿 1 陶", flavor: "陶土堆的搬运工" },
  { id: "quarryman", name: "采石工", icon: "⛰️", category: "resource", categoryZh: "基础资源", effect: "拿石头行动：额外多拿 1 石", flavor: "石场的重劳力" },
  ...
  { id: "miner", name: "矿工", icon: "⛏️", category: "resource", categoryZh: "基础资源", effect: "拿陶或拿石行动：额外多拿 1 份对应资源", flavor: "深入坑道采掘矿脉的熟练工" },
  ...
  { id: "seedMerchant", name: "种子商人", icon: "🌱", category: "farming", categoryZh: "农耕种植", effect: "拿谷或拿菜行动：多得 1 份对应种子", flavor: "农耕播种的核心支柱" },
  { id: "plowman", name: "犁地手", icon: "🚜", category: "farming", categoryZh: "农耕种植", effect: "犁地行动：额外免费多犁 1 块田", flavor: "高效开垦农田的专家" },
  { id: "sower", name: "播种者", icon: "🪴", category: "farming", categoryZh: "农耕种植", effect: "撒种行动：可同时为 2 块田撒种", flavor: "春季大面积播种高手" },
  ...
  { id: "cornShepherd", name: "麦田看守", icon: "🌾", category: "farming", categoryZh: "农耕种植", effect: "撒种行动：撒种后立即获得 1 食物", flavor: "巡视新播种麦苗收取护粮酬劳" },
  ...
  // 3. 牲畜畜牧流派（11 张）
  // ==========================================
  { id: "shepherd", name: "牧羊人", icon: "🐑", category: "livestock", categoryZh: "牲畜畜牧", effect: "买羊行动：额外获得 1 只羊", flavor: "羊群繁衍生息的照料者" },
  { id: "swineherd", name: "养猪人", icon: "🐗", category: "livestock", categoryZh: "牲畜畜牧", effect: "买猪行动：额外获得 1 只猪", flavor: "猪舍扩建的得力帮手" },
  { id: "cattleFarmer", name: "牧牛人", icon: "🐄", category: "livestock", categoryZh: "牲畜畜牧", effect: "买牛行动：额外获得 1 只牛", flavor: "牛群培育的核心支柱" },
  ...
  { id: "milker", name: "挤奶工", icon: "🥛", category: "livestock", categoryZh: "牲畜畜牧", effect: "繁殖阶段：拥有牛或羊时额外产出 1 食物", flavor: "温热鲜奶是清晨的营养之源" },
  { id: "livestockBroker", name: "牲畜经纪人", icon: "🤝", category: "livestock", categoryZh: "牲畜畜牧", effect: "买羊/猪/牛行动：每次额外获得 1 食物", flavor: "在集市促成牲畜交易收取口粮" },
  { id: "woolWeaver", name: "羊毛织工", icon: "🧶", category: "livestock", categoryZh: "牲畜畜牧", effect: "繁殖阶段：每繁殖 1 只羊额外产出 1 食物", flavor: "剪取初生羊毛织造温暖披风" },
  ...
  { id: "animalBreeder", name: "动物育种师", icon: "🐣", category: "livestock", categoryZh: "牲畜畜牧", effect: "买动物行动：若该动物买入后正好成对多得 1 谷物", flavor: "为牲畜挑选绝佳配对以备繁殖" },
  ...
  { id: "blacksmith", name: "铁匠", icon: "⚒️", category: "building", categoryZh: "建造翻修", effect: "建造大改进：减免 1 石头", flavor: "精铁工具助力大建筑落地" },
  ...
  { id: "masterMason", name: "石工大师", icon: "🏰", category: "building", categoryZh: "建造翻修", effect: "翻修石屋行动：减免 1 石头消耗", flavor: "切割石梁建造世代流传的石屋" },
  ...
  { id: "brewer", name: "酿酒师", icon: "🍺", category: "cooking", categoryZh: "饮食烹饪", effect: "每轮开始：若有谷物自动用 1 谷换 4 食物", flavor: "大麦酿造高热量麦芽酒" },
  ...
  { id: "tanner", name: "制皮匠", icon: "👞", category: "cooking", categoryZh: "饮食烹饪", effect: "烹饪牛或猪时：额外获得 2 食物", flavor: "鞣制毛皮换取充足口粮" },
  { id: "herbalist", name: "草药师", icon: "🌿", category: "cooking", categoryZh: "饮食烹饪", effect: "烹饪蔬菜时：每份蔬菜额外产出 1 食物", flavor: "秘制草药浓汤营养翻倍" },
  { id: "masterChef", name: "主厨", icon: "🍳", category: "cooking", categoryZh: "饮食烹饪", effect: "烹饪时不需壁炉/烹饪灶，任意 1 谷/菜换 2 食物", flavor: "普通农舍土灶也能烧出珍馐" },
  ...
  { id: "seasonalWorker", name: "季节工", icon: "🍂", category: "family", categoryZh: "家庭运营", effect: "每个阶段第 1 轮：额外获得 1 谷 + 1 食物", flavor: "随季节迁徙的勤劳打工人" },
  ...
  { id: "oddJobMan", name: "杂务工", icon: "🧹", category: "family", categoryZh: "家庭运营", effect: "打日工行动：额外多拿 1 木材（日工 +2 食物 +1 木）", flavor: "修修补补杂活包揽在身的勤快人" },
  { id: "laborBroker", name: "劳工经纪", icon: "💼", category: "family", categoryZh: "家庭运营", effect: "打日工行动：额外多拿 1 陶土（日工 +2 食物 +1 陶）", flavor: "组织劳工队为工坊提供精壮人手" },
  ...
  { id: "masterBreeder", name: "育种大师", icon: "🏆", category: "scoring", categoryZh: "终局声望", effect: "终局计分：羊/猪/牛三畜齐全额外 +4 分", flavor: "三畜兴旺享誉四方的育种世家" },
